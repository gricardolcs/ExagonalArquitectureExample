...
class BootcampSearchControllerTest
{
    ...
    void testValidFetchEmpty()
    {
        ...
        Mockito.when(bootcampFetchUseCase.findBootcampByName("Bolivian Bootcamp"))
            .thenReturn(expectedBody);
        ResponseEntity<List<BootcampDTO>> result = bootcampController
            .findBootcampByName("Bolivian Bootcamp");
    ...
    void testValidFetchBootcamp()
    {
        ...
        assertEquals(
            expectedBody.get(0).getDepartmentType(),
            actualBody.get(0).getDepartmentType());

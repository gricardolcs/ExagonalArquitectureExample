...
const setStructure = (fieldNames) => {
  return [
    ...
    <Grid>
      <Grid.Column width={8}>
        <CustomField>{fieldNames[6]}</CustomField>
      </Grid.Column>
      <Grid.Column width={8}>
        <CustomField>{fieldNames[7]}</CustomField>
      </Grid.Column>
    </Grid>,
    <Grid>
      <Grid.Column width={8}>
        <CustomField>{fieldNames[8]}</CustomField>
      </Grid.Column>
...
const StructureUserForm = {
  setStructure,
};

export default StructureUserForm;

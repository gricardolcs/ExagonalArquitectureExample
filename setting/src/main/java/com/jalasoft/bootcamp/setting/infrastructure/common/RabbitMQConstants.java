package com.jalasoft.bootcamp.setting.infrastructure.common;
...
public final class RabbitMQConstants
{
    ...
    public static final RabbitMQQueueBuilder APPLICANT_QUEUE = new RabbitMQQueueBuilder(
        APPLICANT_QUEUE_NAME, true, "applicant.key");
    ...
    public static final RabbitMQQueueBuilder NOTIFICATION_QUEUE = new RabbitMQQueueBuilder(
        NOTIFICATION_QUEUE_NAME, true, "notification.key");

    public static final RabbitMQExchangeProperties APPLICATION_TOPIC_EXCHANGE =
        new RabbitMQExchangeProperties("application-exchange", true, false);

    public static final RabbitMQExchangeProperties APPLICATION_FANOUT_EXCHANGE =
        new RabbitMQExchangeProperties("application-fanout", true, false);
    ...
    {
        private final String name;
        // Persists the exchange in case the machine shutdowns, once it's back up the exchange
        // will be brought back alive.
        private final boolean persistingExchange;
        // This exchange is deleted in case all queues stopped using this exchange.
        private final boolean autoDelete;

        public RabbitMQExchangeProperties(
            String name,
            boolean persistingExchange,
            boolean autoDelete)
        {
            this.name = name;
